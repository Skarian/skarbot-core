...
- **selectively informed by nemoclaw and oh-my-pi** where the gain is real

The rule is simple: if an idea makes Skarbot larger without making the household assistant materially better, it does not belong.
