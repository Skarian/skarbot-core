...
- Documentation style: write docs like a product spec or operator manual, not an essay. Start with the concrete behavior. Prefer product nouns over abstraction. State policies directly. Keep sentence count low. Avoid padding, meta-explanation, section-intro throat clearing, and "why this section exists" prose. Stay close to the user's phrasing when editing docs.
