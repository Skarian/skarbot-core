...
- GitHub integration without ordinary PAT sprawl
...
When repository access is needed, the preferred path is an `exe.dev` GitHub integration rather than long-lived tokens stored inside the VM.
